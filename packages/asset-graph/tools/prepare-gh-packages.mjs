...
// require），lib/host.js 的行内注释与断言也带上包名。直接沿用未作用域的 lib/，
// 会让 GitHub Packages 上的包在浏览器里以错误 id 注册。
// build-lib.mjs 按「所在目录的 package.json」推导名字，所以在 OUT 里跑一次即可；
// 同时这一步也让 prepack 的 build-lib --check 闸对改名副本依然成立。
