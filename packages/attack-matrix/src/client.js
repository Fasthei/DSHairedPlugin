...
function applyClient(ctx) {
  ...
  ctx.effect(function () {
    return styles.insert([
      ...
      '.rtm-cov-bar{position:relative;flex:1;height:6px;border-radius:3px;background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-border-l1));overflow:hidden}',
      ...
      '.rtm-group-h{display:flex;align-items:baseline;gap:7px;font-size:11.5px;position:sticky;top:0;z-index:1;background:var(--dsw-alias-bg-layer-1,transparent);padding:2px 0}',
      ...
      '.rtm-tl:hover{background:var(--dsw-alias-bg-layer-2,transparent)}',
