...
//   - 客户端 RPC 走宿主路由（基址 /dsh-redteam-attack-matrix），客户端用 fetch 调
  const tools = []

  // TODO: 在此注册本插件的模型工具。示例（去掉注释即可用）：
  //
  // const t = defineTool({
  //   name: 'attack_matrix_example',
  ...
  console.log('[rtasset] redteam-attack-matrix host half ready; tools =', tools.length)
